...
public class ArticleSearchService {
    ...
    public ArticleDTO findArticle(Long articleId) throws Exception {
    ...
    public List<ArticleDTO> findArticlesByBoardIdAndPaging(Long boardId, Integer pageNum) throws Exception {
    ...
    public List<ArticleDTO> findArticlesByBoardId(Long boardId) throws Exception {
        BoardEntity findBoard = boardStatusService.findBoard(boardId);
    ...
    public List<ArticleDTO> findArticlesByBoardName(String boardName) throws Exception {
        ...
        List<ArticleDTO> collect = findArticles.stream().map(ArticleDTO::new).collect(Collectors.toList());
        return collect;
    }
}
